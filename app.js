...
const I18N = {
  ja: {
    ...
    subtitle: "AI駆動開発で17個の「悩み解決アプリ」を構築。出典記事の悩みを深読みし、摩擦ゼロで解決を目指す。",
    stat_apps: "アプリ",
    stat_time: "構築時間",
    stat_cost: "月額コスト",
    ...
    research_title: "研究背景",
    research_desc: "「AIを活用したアプリ」と聞くと、多くの人は「アプリの中でAIモデルが動いている」と想像します。しかし実際には、AI駆動開発 — AIとともにアプリを作る — という形が主流です。このプロジェクトでは、ネット上の「切実な悩み」の出典記事を深く読み込み、悩みの本質を理解した上で、AIモデルを一切内蔵せずにアプリを構築しました。v2では「めんどくさがりが1タップで価値を得られる」設計原則で全アプリを改良しています。",
    link_github: "GitHub で見る →",
    footer_text: " — AI駆動開発 × 悩み深読み × 摩擦ゼロ設計",
    cta: "使ってみる →",
    badge_mobile: "📱 スマホ",
    badge_desktop: "💻 PC",
    badge_both: "📱💻 両対応",
  ...
  en: {
    title: "17 Apps Experiment",
    subtitle: "17 pain-solving apps built with AI-driven development. Deep-read source articles, minimize friction.",
    stat_apps: "Apps",
    ...
    research_desc: "When people hear \"AI-powered app,\" they imagine an AI model running inside the app. In reality, AI-driven development — building apps with AI — is the dominant paradigm. In this project, we deep-read source articles of real frustrations, understood the root causes, and built apps with zero AI models embedded. In v2, every app was redesigned around the principle: \"lazy users should get value in one tap.\"",
    link_github: "View on GitHub →",
    footer_text: " — AI-driven development × Deep-read pain points × Zero-friction design",
    cta: "Try it →",
    badge_mobile: "📱 Mobile",
...
const APPS = [
  {
    id: "meal-rescue", icon: "🍳",
    name_ja: "献立レスキュー", name_en: "MealRescue",
    ...
    solve_ja: "開いた瞬間に今日のおすすめ3品を表示。レシピ100件超、疲れた日モード、1週間ローテーション生成。",
    solve_en: "Instant 3-dish recommendation on open. 100+ recipes, tired-day mode, weekly rotation generator.",
    solve_level: 4,
    device: "mobile",
  ...
  {
    id: "fridge-watch", icon: "🧊",
    name_ja: "冷蔵庫番", name_en: "FridgeWatch",
    ...
    solve_ja: "よく買う食材をワンタップ登録（期限自動設定）。冷凍保存ヒント、使い切りレシピリンク付き。",
    solve_en: "One-tap registration for common foods (auto-set expiry). Freeze tips and recipe links for expiring items.",
    solve_level: 5,
    device: "mobile",
  ...
  {
    id: "med-reminder", icon: "💊",
    name_ja: "おくすりリマインダー", name_en: "MedReminder",
    ...
    solve_ja: "巨大「飲みました」ボタンで即記録。残薬カウンター、未服用時の赤バナー警告付き。",
    solve_en: "Large \"Taken\" button for instant recording. Pill counter and red overdue banner.",
    solve_level: 5,
    device: "mobile",
  ...
  {
    id: "memory-cards", icon: "🧠",
    name_ja: "暗記カード", name_en: "MemoryCards",
    ...
    solve_ja: "SM-2アルゴリズムで最適復習。テキスト一括インポート、リバースモード、周回カウンター付き。",
    solve_en: "SM-2 optimal review. Bulk text import, reverse mode, repetition counter.",
    solve_level: 5,
    device: "mobile",
  ...
  {
    id: "water-wise", icon: "🌱",
    name_ja: "水やり判定", name_en: "WaterWise",
    ...
    solve_ja: "GPS自動位置取得→天気データ→科学的水やり判定。「じょうろ○杯/㎡」で表示。20種の作物対応。",
    solve_en: "GPS auto-location → weather data → scientific watering advice. Shows 'watering cans per m²'. 20 crop types.",
    solve_level: 5,
    device: "mobile",
  ...
  {
    id: "pitch-checker", icon: "🎵",
    name_ja: "音程チェッカー", name_en: "PitchChecker",
    ...
    solve_ja: "リアルタイム音程検出＋基準音再生。↑↓矢印で高い/低いが直感的に分かる。楽器別プリセット対応。",
    solve_en: "Real-time pitch detection + reference tone playback. Arrow indicators for sharp/flat. Instrument presets.",
    solve_level: 5,
    device: "mobile",
  ...
  {
    id: "pdf-liberator", icon: "📄",
    name_ja: "PDF解放", name_en: "PDFLiberator",
    ...
    solve_ja: "PDFの表を自動検出→Excel/CSV変換。テキスト抽出モード、ページ範囲指定にも対応。",
    solve_en: "Auto-detects PDF tables → Excel/CSV. Also supports text extraction mode and page range selection.",
    solve_level: 5,
    device: "desktop",
  ...
  {
    id: "quick-budget", icon: "💰",
    name_ja: "ざっくり家計簿", name_en: "QuickBudget",
    ...
    solve_ja: "銀行CSV→自動分類。「固定費/変動費/貯蓄」の3分類モード、予算設定で「あと○円」表示。",
    solve_en: "Bank CSV → auto-categorize. Simple 3-category mode (fixed/variable/savings), budget tracking.",
    solve_level: 4,
    device: "desktop",
  ...
  {
    id: "csv-query", icon: "🔍",
    name_ja: "CSV集計", name_en: "CSVQuery",
    ...
    solve_ja: "SQL不要の「かんたんモード」で誰でも集計。CSV読込で自動分析。Excel出力対応。",
    solve_en: "No-code 'Easy Mode' for anyone to aggregate. Auto-analysis on CSV load. Excel export.",
    solve_level: 5,
    device: "desktop",
  ...
  {
    id: "report-factory", icon: "📊",
    name_ja: "レポート工場", name_en: "ReportFactory",
    ...
    solve_ja: "日報テンプレート追加。1回入力→PDF/テキスト/Markdownを同時生成。前回値を自動引き継ぎ。",
    solve_en: "Daily report template. One input → PDF/text/Markdown simultaneously. Auto-fills previous values.",
    solve_level: 4,
    device: "desktop",
  ...
  {
    id: "freelance-books", icon: "📒",
    name_ja: "フリーランス経理", name_en: "FreelanceBooks",
    ...
    solve_ja: "銀行CSV自動仕訳＋手入力モード。申告方式ガイド付き、クリエイター向け分類ルール対応。",
    solve_en: "Bank CSV auto-journaling + manual entry. Tax filing guide, creator-specific category rules.",
    solve_level: 5,
    device: "desktop",
  ...
  {
    id: "stock-watch", icon: "📦",
    name_ja: "在庫ウォッチ", name_en: "StockWatch",
    ...
    solve_ja: "在庫管理＋メニュー原価計算。食材単価×使用量で原価率を自動算出。品目別発注点アラート。",
    solve_en: "Inventory management + menu cost calculation. Auto-calculates food cost ratio. Per-item reorder alerts.",
    solve_level: 4,
    device: "desktop",
  ...
  {
    id: "photo-sorter", icon: "📸",
    name_ja: "写真仕分け", name_en: "PhotoSorter",
    ...
    solve_ja: "EXIF分類＋重複検出＋サイズ分析。日付別フォルダに整理したZIPで出力。HEIC→JPG変換対応。",
    solve_en: "EXIF sorting + duplicate detection + size analysis. Outputs organized ZIP by date. HEIC→JPG conversion.",
    solve_level: 4,
    device: "desktop",
  ...
  {
    id: "oshi-digest", icon: "⭐",
    name_ja: "推しダイジェスト", name_en: "OshiDigest",
    ...
    solve_ja: "ジャンル別プリセットフィードで即開始。キーワードフィルタで重要記事をハイライト。推し活支出トラッカー付き。",
    solve_en: "Genre preset feeds for instant start. Keyword filter highlights important articles. Includes spending tracker.",
    solve_level: 3,
    device: "both",
  ...
  },
  {
    ...
    solve_ja: "クイック入力プリセットで記録時間1/3に。バイタル異常値アラート、1日まとめPDF出力。",
    solve_en: "Quick-input presets cut recording time by 2/3. Vital sign alerts, daily summary PDF.",
    solve_level: 5,
    device: "both",
  ...
  {
    id: "test-maker", icon: "📝",
    name_ja: "テストメーカー", name_en: "TestMaker",
    ...
    solve_ja: "CSV一括インポートで問題登録。配点管理、大問構成、解答用紙PDF独立生成。日本語難易度分析対応。",
    solve_en: "CSV bulk import for questions. Point allocation, sections, separate answer sheet PDF. Japanese difficulty analysis.",
    solve_level: 4,
    device: "both",
  ...
  {
    id: "run-dash", icon: "🏃",
    name_ja: "ランダッシュ", name_en: "RunDash",
    ...
    solve_ja: "GPX/FIT分析＋心拍ゾーン＋GAP（標高補正ペース）。ベストスプリット自動検出、ペースvs心拍散布図。",
    solve_en: "GPX/FIT analysis + HR zones + GAP (grade adjusted pace). Auto-detects best splits, pace vs HR scatter.",
    solve_level: 5,
    device: "both",
...
function renderCards() {
  ...
  grid.innerHTML = apps
    .map((app) => {
      ...
      const solve = lang === "ja" ? app.solve_ja : app.solve_en;
      const dots = "●".repeat(app.solve_level) + "○".repeat(5 - app.solve_level);
      ...
      return `<a href="${app.url}" target="_blank" rel="noopener"
        ...
        <p class="app-card__solve">${solve}</p>
        <div class="app-card__level"><span class="app-card__dots">${dots}</span></div>
